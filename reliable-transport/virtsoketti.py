...
class Virtuaalisoketti(s.socket):
    ...
    def recvfrom(self, puskurin_koko):
        ...
        while True:
            ...
            if rand.random() < self.tn_pudotus:
                print('Virtuaalisoketti hukkasi paketin.')
            else:
                self.viive()
    ...
    def viive(self):
        ...
        if rand.random() < self.tn_viive:
            ...
            time.sleep(viive)
            print('Virtuaalisoketti aiheutti viiveen: {} s'.format(viive))
    ...
    def bittivirhe(self, data):
        ...
        # tavujonoksi muunnettaessa ykkösen eteen lisätään niin monta
