...
def main():
    ...
    while True:
        try:
            ...
            # Jos luottokerroksen ajastin ei ole None, kutsutaan sen
            # cancel-metodia, ts. lopetetaan säikeen suoritus.
            if luottokrs.ajastin:
                luottokrs.ajastin.cancel()
